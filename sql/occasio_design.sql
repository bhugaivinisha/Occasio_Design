...
(6, 6, 6, 6, '2026-06-08', '2026-04-17 00:31:00', 'Chitwan Conference Hall', 120, 30000.00, 'confirmed', 'Set up a brand color stage and microphone area.'),
(7, 7, 7, 7, '2026-06-15', '2026-04-17 00:31:00', 'Dharan Community Hall', 100, 22000.00, 'pending', 'Include diya decoration and rangoli corner.'),
(8, 8, 8, 8, '2026-06-25', '2026-04-17 00:31:00', 'Nepalgunj Royal Hall', 110, 34000.00, 'confirmed', 'Add a heart-shaped stage with red flowers.'),
(9, 9, 9, 9, '2026-07-02', '2026-04-17 00:31:00', 'Hetauda School Hall', 70, 17500.00, 'confirmed', 'Make a memory wall for photos and notes.'),
(10, 10, 10, 10, '2026-12-31', '2026-04-17 00:31:00', 'Pokhara Rooftop Venue', 140, 27500.00, 'confirmed', 'Need countdown numbers, lights, and confetti.'),
(11, 11, 5, 10, '2026-05-20', '2026-05-15 07:25:10', 'Pokhara Hall, Simpani, Pokhara', 200, 21500.00, 'cancelled', 'thank you !'),
(12, 11, 5, 9, '2026-05-21', '2026-05-15 07:59:08', 'Pokhara Hall, Simpani, Pokhara', 99, 18500.00, 'pending', 'Thank You !'),
(13, 12, 7, 10, '2026-06-17', '2026-05-15 10:09:19', 'Pokhara Hall, Simpani, Pokhara', 200, 23500.00, 'pending', 'Thank you !'),
(14, 12, 4, 10, '2026-06-12', '2026-05-16 02:18:35', 'Pokhara Hall, Simpani, Pokhara', 200, 25500.00, 'pending', ''),
(15, 12, 4, 10, '2026-06-12', '2026-05-16 02:18:37', 'Pokhara Hall, Simpani, Pokhara', 200, 25500.00, 'cancelled', '');
...
(1, 'Birthday Party', 'Decorated birthday setup for kids, teens, or adults with balloons, cake table, and backdrop.', 'Celebration', 12000.00, 80, 'Indoor / Outdoor Venue', 4, '2026-04-17 00:31:00', 'active'),
(2, 'Wedding Anniversary', 'Elegant anniversary decoration with flowers, candles, lights, and romantic theme styling.', 'Celebration', 15000.00, 100, 'Banquet Hall', 5, '2026-04-17 00:31:00', 'active'),
(3, 'Wedding Reception', 'Premium reception decoration with stage backdrop, floral arches, lighting, and guest seating.', 'Wedding', 35000.00, 250, 'Reception Hall', 8, '2026-04-17 00:31:00', 'active'),
(4, 'Baby Shower', 'Soft pastel themed baby shower setup with balloons, props, and welcome board.', 'Family', 18000.00, 60, 'Home / Hall', 4, '2026-04-17 00:31:00', 'active'),
...
(6, 'Prakash Adhikari', 'prakash.adhikari@example.com', '9810000006', '$2a$10$GUbQrqzbnCqA3lw6pu1ZKeBn1ZqSatg3T5kPjrvhIi7kPjv23P/xO', 'Male', '2001-09-18', 'user', 'Chitwan, Nepal', '2026-04-17 00:31:00'),
(7, 'Nisha Rai', 'nisha.rai@example.com', '9810000007', '$2a$10$GUbQrqzbnCqA3lw6pu1ZKeBn1ZqSatg3T5kPjrvhIi7kPjv23P/xO', 'Female', '2005-12-03', 'user', 'Dharan, Nepal', '2026-04-17 00:31:00'),
(8, 'Sanjay BC', 'sanjay.bc@example.com', '9810000008', '$2a$10$GUbQrqzbnCqA3lw6pu1ZKeBn1ZqSatg3T5kPjrvhIi7kPjv23P/xO', 'Male', '2000-04-25', 'user', 'Nepalgunj, Nepal', '2026-04-17 00:31:00'),
